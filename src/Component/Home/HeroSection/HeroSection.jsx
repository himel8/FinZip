...
const HeroSection = () => {
  return (
    <section className="w-[95%] sm:w-[90%] md:w-[80%] mx-auto flex justify-center items-center min-h-screen flex-wrap-reverse lg:flex-nowrap gap-10 lg:gap-0 my-10 lg:my-0  lg:mb-20 mb-0">
